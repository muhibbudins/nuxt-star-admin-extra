      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-description">
              Add attribute <code>"v-b-tooltip.html.*"</code> prop for desired position
            </p>
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-description">
              Add attribute <code>:placement="*placement"</code> for desired position
            </p>
            <b-row>
              <b-col v-for="placement in placements" :key="placement" md="4" class="py-2">
